...
export default function ReportPage() {
  ...
  return (
    <MainLayout
      title="LAPORAN"
      subtitle="Kelola dan pantau laporan keuangan periodik Anda."
      headerActions={
        <button
          onClick={openGenerateConfirm}
          disabled={isGenerating}
          className="group relative px-8 py-4 cta-gradient text-white rounded-2xl font-bold transition-all shadow-md active:scale-95 flex items-center justify-center gap-3 overflow-hidden cursor-pointer disabled:opacity-50"
        >
          ...
          <div className="flex items-end">
             {(periodType || startDate || endDate) && (
              <button 
                ...
                className="mb-3 text-xs text-primary font-bold hover:underline ml-2 cursor-pointer"
              >
                Reset Filter
              </button>
            )}
             ...
             <div className="p-6">
                ...
                <div className="flex gap-3 mt-8">
                   <button
                      ...
                      className="flex-1 py-3 border border-gray-200 text-gray-600 rounded-xl font-bold text-sm hover:bg-gray-50 transition-colors cursor-pointer"
                   >
                     Batal
                   </button>
                   <button
                      ...
                      disabled={isGenerating}
                      className="flex-1 py-3 cta-gradient text-white rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all active:scale-95 cursor-pointer disabled:opacity-50"
                   >
                     {isGenerating ? (
